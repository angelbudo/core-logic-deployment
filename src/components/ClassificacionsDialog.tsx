  ...
  return (
    <div className="avatar-scroll max-h-[55vh] overflow-y-auto pr-2 space-y-1.5">
      {entries.map((e) => {
        ...
        return (
          <Link key={e.profile.user_id} to={`/perfil/${e.profile.user_id}`} className="flex items-center gap-2 border border-primary/25 p-2 text-neutral-900 bg-stone-200 hover:bg-stone-300 transition mx-0 ml-px -mr-[7px] rounded-xl">
