  ...
  return (
    <main className="menu-screen min-h-screen flex flex-col items-center justify-center px-5 py-8">
      ...
      <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
        <DialogContent className="fixed left-[50%] top-[50%] z-50 max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg w-[90vw] sm:max-w-md h-[60vh] flex-col p-0 rounded-lg border border-primary/30 bg-gray-200 text-background overflow-hidden py-[10px] px-[10px] flex items-start justify-start">
          {(() => {
